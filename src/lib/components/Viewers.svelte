<div class="flex items-center gap-8 pb-5">
	<div class="group relative flex h-12 w-12 items-center justify-center">
		...
		<span class="absolute -bottom-6 z-20 rounded-full bg-white/10 px-2 py-px text-xs text-white/80"
			>Me</span
		>
	</div>
	<div class="group relative flex h-12 w-12 items-center justify-center">
		<div
			class="flex h-12 w-12 items-center justify-center rounded-full border-2 border-purple-200/90 bg-purple-300/80 text-3xl ring-4 ring-transparent"
		>
			<span class="drop-shadow-lg">😤</span>
		</div>
		<span class="absolute -bottom-6 z-20 rounded-full bg-white/10 px-2 py-px text-xs text-white/80"
